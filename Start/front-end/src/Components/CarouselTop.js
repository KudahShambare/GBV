          ...
          <Card>
            <Card.Body>
              ...
              <Card.Text>
                ...
                <p>
                  We provide you with a social worker to support you and discuss
                  any issues and problems you may have. All of this whilst
              ...
              <Container>
                <Row className="text-center">
                  ...
                  <Col md={2} sm={2}>
                    <p>
                      <strong style={{ verticalAlign: "middle" }}>OR</strong>
                    </p>
                  </Col>
                  <Col md={5} sm={5}>
                    <Button
                      href="tel:10111"
                      class="btn-call-police  scrollto animate__animated animate__fadeInUp"
                      style={{
              ...
              <br />
              <p>
                <strong>Note:</strong> We are open from 8am to 6pm
              </p>
            </Card.Body>
          </Card>
        </Col>
