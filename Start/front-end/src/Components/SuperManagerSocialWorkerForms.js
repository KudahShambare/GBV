...
const SocialWorkerSignUpRequestCards = ({ caseId})=> {
  ...
  return (
    <>
      <br/>
      <Container className="text-center" style ={{backgroundColor:"red"}}>   
        <Card style ={{backgroundColor:"green", color:"white"}}>
          <CardHeader
            title={`Employee ID: ${caseId}`}
            subheader={<strong style ={{color:"white"}}>Name of Social Worker: {caseId}</strong>}
            />
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <CardContent>
              <Form.Group className="mb-3"> 
                <Form.Label>Please enter the employee ID of the social worker you want to authorise: </Form.Label>
...
export default SocialWorkerSignUpRequestCards;