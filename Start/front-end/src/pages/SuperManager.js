    ...
    <>
        ...
        <Grid item xs={12} sm={4} lg={4} xl={4} xxl={4}>
            <div className={classes.card}>
              ...
              <Typography variant="h5" component="h3" className={classes.title}>
                <a href='#liveCases' style={{ "text-decoration": "none", "color":"white"}}>Live Cases</a>
              </Typography>
              <Typography className={classes.featureList}>
                <a href='#liveCases'style={{ "text-decoration": "none", "color":"white"}}>Monitor the GBV victim cases and which social worker is assigned to each one.</a>
              </Typography>
            </div>
          </Grid>
          <Grid item xs={12} sm={4}>
            <div className={classes.card}>
              ...
              />
              <Typography variant="h5" component="h3" className={classes.title}>
                <a href="#socialWorkersSignUp" style={{ "text-decoration": "none", "color":"white"}}>Social Workers Sign Up requests</a>
              </Typography>
              <Typography className={classes.featureList}>
                <a href="#socialWorkersSignUp" style={{ "text-decoration": "none", "color":"white"}} >Click here to chose who has access to the company data</a>
              </Typography>
            </div>
          </Grid>
          <Grid item xs={12} sm={4}>
            <div className={classes.card}>
              ...
              />
              <Typography variant="h5" component="h3" className={classes.title}>
                <a href="#fundersShareholdersSignUp" style={{ "text-decoration": "none", "color":"white"}}> Funders and shareholders sign up requests</a>
              </Typography>
              <Typography className={classes.featureList}>
                <a href="#fundersShareholdersSignUp" style={{ "text-decoration": "none", "color":"white"}}>Click here to chose who has access to the company data</a>
              </Typography>
            </div>
          </Grid>
        </Grid>
      ...
      <Container id="liveCases" component="section" maxWidth="lg">
        ...
        <>
          <br />
          <br/>
          {<h3 className="managerHeading" ><strong>Live Cases:</strong></h3>}
            {caseInfo.map((post) => {
              return (
                <Col sm={12} md={12} lg={8} xl={12} style ={{backgroundColor:"green", color:"white"}} >
                  <Forms
      ...
      <Container id="socialWorkersSignUp" component="section" maxWidth="lg">
          <Element name="test7" className="element" id="containerElement" style={{
            ...
            <>
              <br />
              {<h3 className="managerHeading" ><strong>Social Workers Sign Up Requests:</strong></h3>}
              {caseInfo.map((post) => {
                return (
      ...
      <Container id="fundersShareholdersSignUp" component="section" maxWidth="lg">
          <Element className="element" id="containerElement" style={{
            ...
            <>
              <br />
              {<h3 className="managerHeading" ><strong>Funders and Shareholders sign up request:</strong></h3>}
              {caseInfo.map((post) => {
                return (
                  <Col sm={12} md={12} lg={8} xl={12} >
