          ...
          <div className="text-center">
            ...
            <Accordion>
              ...
              >
                <Typography>
                  {" "}
                  <strong>
                  What is the purpose of the Victim Empowerment Programme (VEP)?
              ...
              <AccordionDetails>
                <Typography className="faq-answer">
                  ...
                  crime and violence. The VEP's support services also extends to
                  Gender-Based-Violence (GBV), whereby the therapeutic services
                  aids to deal with the impact of the incident that had been
                  experienced.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
              ...
              >
                <Typography>
                  {" "}
                  <strong>
                  Who will respond to my enquiry on the Touching Nations App?
            ...
            <Accordion>
              ...
              >
                <Typography>
                  {" "}
                  <strong>                    Are Touching Nations VEP services free?{" "}
  </strong>
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography className="faq-answer">
                  Touching Nations VEP services are free and open to members of
                  the public that are 18 years and older and reside within
                  Elsies River, Delft and its surrounding areas. What services
                  does Touching Nations VEP offer? The focus of the services is
                  two-fold: firstly, to render psychosocial support services
                  that encompasses therapeutic counselling on an individual,
                  couple, family, and group. Secondly, educational workshops
                  that comprise awareness and preventive measures around crime
                  and violence.
                </Typography>
              </AccordionDetails>
            </Accordion>
